...
QUESTIONNAIRE_DEFINITIONS = {
    ...
    "psd": {
        ...
        "color": "blue",
        "questions": [
            {"id": "wake_date", "type": "date", "label": "Datum (dnešní den – den probuzení)"},
            {"id": "sleep_latency", "type": "choice", "label": "Jak dlouho vám trvalo usnout?",
             "options": [{"label": "Méně než 15 minut", "value": "a"}, {"label": "15–30 minut", "value": "b"}, {"label": "30–60 minut", "value": "c"}, {"label": "Více než 60 minut", "value": "d"}]},
            {"id": "total_sleep_time", "type": "choice", "label": "Kolik hodin jste celkem spal/a?",
             "options": [{"label": "Méně než 5 hodin", "value": "a"}, {"label": "5–6 hodin", "value": "b"}, {"label": "6–7 hodin", "value": "c"}, {"label": "Více než 7 hodin", "value": "d"}]},
            {"id": "night_awakenings", "type": "choice", "label": "Jak často jste se během noci probudil/a?",
             "options": [{"label": "Vůbec", "value": "a"}, {"label": "1× ", "value": "b"}, {"label": "2–3×", "value": "c"}, {"label": "4× a více", "value": "d"}]},
            {"id": "sleep_quality", "type": "choice", "label": "Jak hodnotíte svůj spánek?",
             "options": [{"label": "Velmi špatný", "value": "a"}, {"label": "Špatný", "value": "b"}, {"label": "Dobrý", "value": "c"}, {"label": "Velmi dobrý", "value": "d"}]},
        ]
    },
    "tavns_diary": {
    ...
    "mfi20": {
        ...
        "description": "Vyplňte 1× týdně. Každá položka: 1 = zcela nesouhlasím … 5 = zcela souhlasím.",
        "frequency": "weekly",
        "icon": "activity",
        "color": "orange",
        "questions": [
            {"id": "study_week", "type": "number", "label": "Týden studie č.", "min": 1, "max": 52},
            {"id": "gf1", "type": "scale5", "label": "Cítím se unavený/á.", "options": ["1","2","3","4","5"]},
            {"id": "gf2", "type": "scale5", "label": "Celkově se necítím příliš svěže.", "options": ["1","2","3","4","5"]},
            {"id": "gf3", "type": "scale5", "label": "Cítím se svěží. (R)", "options": ["1","2","3","4","5"]},
            {"id": "gf4", "type": "scale5", "label": "Cítím se ve formě. (R)", "options": ["1","2","3","4","5"]},
            {"id": "pf1", "type": "scale5", "label": "Fyzicky se cítím unavený/á.", "options": ["1","2","3","4","5"]},
            {"id": "pf2", "type": "scale5", "label": "Fyzicky se cítím vyčerpaný/á.", "options": ["1","2","3","4","5"]},
            {"id": "pf3", "type": "scale5", "label": "Cítím se silný/á. (R)", "options": ["1","2","3","4","5"]},
            {"id": "pf4", "type": "scale5", "label": "Cítím se ve fyzicky dobré kondici. (R)", "options": ["1","2","3","4","5"]},
            {"id": "ra1", "type": "scale5", "label": "Mám málo zájmů.", "options": ["1","2","3","4","5"]},
            {"id": "ra2", "type": "scale5", "label": "Dělám jen málo věcí.", "options": ["1","2","3","4","5"]},
            {"id": "ra3", "type": "scale5", "label": "Jsem schopen/na vykonávat spoustu věcí. (R)", "options": ["1","2","3","4","5"]},
            {"id": "ra4", "type": "scale5", "label": "Provozuji mnoho činností. (R)", "options": ["1","2","3","4","5"]},
            {"id": "rm1", "type": "scale5", "label": "Nejsem příliš motivovaný/á.", "options": ["1","2","3","4","5"]},
            {"id": "rm2", "type": "scale5", "label": "Rád/a dělám věci. (R)", "options": ["1","2","3","4","5"]},
            {"id": "rm3", "type": "scale5", "label": "Musím se nutit k tomu, abych něco dělal/a.", "options": ["1","2","3","4","5"]},
            {"id": "rm4", "type": "scale5", "label": "Chybí mi motivace.", "options": ["1","2","3","4","5"]},
            {"id": "mf1", "type": "scale5", "label": "Mám potíže se soustředěním.", "options": ["1","2","3","4","5"]},
            {"id": "mf2", "type": "scale5", "label": "Je pro mě obtížné myslet jasně.", "options": ["1","2","3","4","5"]},
            {"id": "mf3", "type": "scale5", "label": "Myslí mi to. (R)", "options": ["1","2","3","4","5"]},
            {"id": "mf4", "type": "scale5", "label": "Je pro mě obtížné se soustředit.", "options": ["1","2","3","4","5"]},
        ]
    },
    "tavns_adverse": {
